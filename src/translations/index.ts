export const translations = {
    de: {
        ...
        products: {
            ...
            title: 'Organische',
            titleHighlight: 'Präzisionslösungen',
            subtitle: 'Maßgeschneiderte Düngemittel für professionelle Anforderungen – entwickelt mit Fokus auf Wirksamkeit und Nachhaltigkeit.',
            filters: { all: 'Alle Produkte', sport: 'Sportrasen', golf: 'Golfrasen' },
        ...
        faq: {
            ...
            subtitle: 'Alles, was Sie über organische Rasenpflege wissen müssen.',
    ...
    en: {
        header: {
            items: [
                { label: 'Philosophy', href: '#philosophie' },
                { label: 'Case Study', href: '#casestudy' },
                { label: 'Benefits', href: '#vorteile' },
                { label: 'Products', href: '#produkte' },
                { label: 'I.C.E. Technology', href: '#ice' },
        ...
        products: {
            ...
            title: 'Organic',
            titleHighlight: 'Precision Solutions',
            subtitle: 'Tailor-made fertilizers for professional requirements – developed with a focus on effectiveness and sustainability.',
            filters: { all: 'All Products', sport: 'Sports Turf', golf: 'Golf Turf' },
        ...
        faq: {
            ...
            subtitle: 'Everything you need to know about organic turf care.',
